...
class Config:
    ...
    API_KEY = "AIzaSyDjRk7Vu_4kqSGorffwba6k57tFG_eZKIs"
    ...
    AUDIO_FILE = "https://github.com/DerikR01/Plataforma/raw/refs/heads/main/assets/assets_audio_paloma_audio.mp3"
    AUDIO_DURATION = 7
...
class NewPages:
    ...
    def show_home_page():
        ...
        <div style="text-align: center;">
            <h3>🔓 Acesso Ilimitado por Apenas R$19,90/mês</h3>
        </div>
        """, unsafe_allow_html=True)
    ...
    def setup_sidebar():
        with st.sidebar:
            ...
            <div class="vip-badge">
                ...
                <p style="margin: 0; font-size: 1.5em; font-weight: bold;">R$ 34,90/mês</p>
